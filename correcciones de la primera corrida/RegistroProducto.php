    ...
    <div>
      ...
      <form method="post" enctype="multipart/form-data">
          <div class="form-group">
              ...
              <h5>Nombre:</h5>
              <input type="text" name="NombreProducto" placeholder="Ingrese el Nombre" class="form-control controls" required pattern ="[a-zA-Z ]+" title = "Ingrese un nombre válido">
              <h5>Descripcion:</h5>    
              <input type="text" name="DescripcionProducto" placeholder="Ingrese la descripcion" class="form-control controls" required  pattern = "[a-zA-Z0-9,.;: ]+" title = "Ingrese una descripcion válida">
              <!--
              <h5>Sucursal:</h5>
             <select class="form-control" name="SucursalProducto">
              ...
              <h5>Cantidad:</h5>
              <input type="number" min="1" max = "9999999" name="CantidadProducto" placeholder="Ingrese la Cantidad" class="form-control controls" required pattern ="^[0-9]+" title = "ingrese como minimo 1 producto">
              <h5>Precio:</h5>
              <input type="number" min="1" max = "9999999" name="PrecioProducto" placeholder="Ingrese el Precio" class="form-control controls" required pattern ="^[0-9]+" title = "ingrese precio válido">
              <h5>Imagen:</h5>
