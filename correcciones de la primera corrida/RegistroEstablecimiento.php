    ...
    <div>
        ...
        <form method="post" enctype="multipart/form-data">
          <div class="form-group">
              ...
              class="form-control controls" required pattern ="[a-zA-Z ]+">
              <h5>Direccion:</h5>    
              ...
              class="form-control controls" required pattern ="[0-9]+">
              ...
              <h5>Contraseña:</h5>
              <input type="password"minlength ="8" name="PasswordEncargado" placeholder="Ingrese una contraseña" 
