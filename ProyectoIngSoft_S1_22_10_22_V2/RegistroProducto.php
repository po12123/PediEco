...
if (isset($_POST['guardar'])) {
    if (isset($_FILES['foto']['name'])) {
        ...
        $query = "INSERT INTO producto (Nombres_Producto, Descripcion_Producto, Tiempo_Disponible, Cantidad_Producto, Precio_Producto ,Imagen_Producto, Disponible_Producto, Id_Establecimiento, Fecha_Publicacion) values ('$nombreProducto','$descripcionProducto', '$tiempoDisponible', '$cantidadProducto', '$precioProducto','$binariosImagen','$disponibleProducto', '6', now())";
