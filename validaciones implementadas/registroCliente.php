    ...
    <div>
      ...
      <form method="post" enctype="multipart/form-data">
          <div class="form-group">
              ...
              <h5>Nombre:</h5>
              <input type="text" minlength ="8" name="Nombre" placeholder="Ingrese el Nombre" class="form-control controls" required="" pattern ="[a-zA-Z]+" title= " ingrese un nombre correcto">
              <h5>Apellidos:</h5>    
              <input type="text" name="Apellidop" placeholder="Ingrese los apellidos" class="form-control controls" required pattern ="[a-zA-Z]+" title= " ingrese un apellido correcto">
              <h5>Telefono:</h5>
              <input type="text" name="Telefono" placeholder="Ingrese el numero de telefono" class="form-control controls" required pattern ="[0-9]+" title = "ingrese un numero valido">
              <h5>Correo electronico:</h5>
              <input type="text" name="Email" placeholder="Ingrese el correo electronico" class="form-control controls" required pattern = "[a-z]+">
              <h5>Contraseña:</h5>
              <input type="password" minlength = '8' name="Password" placeholder="Ingrese una contraseña" class="form-control controls" required>
          </div>
          <div class="form-group">
