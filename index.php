...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html">PediEco</a></h1>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a id="z" class="" href="catalogo.php">Ver Catalogo
      ...
      <a style="display: none;" id="botonIniciarSesion" href="loginInterface.php" class="get-started-btn">
        <b>Iniciar Sesión</b> 
      </a>
  ...
  <section id="log1" class="d-flex justify-content-center align-items-center">
    <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
      ...
      <a href="catalogo.php" id="k" class="btn-get-started">Ver Catalogo</a>
    </div>
  </section><!-- End Hero -->
  <main id="main">
        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="catalogo.php" id="f">Catalogo</a></li>
