...
function comprobarCampos(e){
    switch(e.classList[0]){
        ...
        break;
        case "input-confirmarcontraseña":
            if(expresiones.confirmarcontraseña.test(e.value)){
                borrarMensajeErrorInput('m-confirmarcontraseña');
                return 0;
            }else{
                motrarMensajeErrorInput('m-confirmarcontraseña','La contraseña tiene que estar entre 8 y 25 caracteres');
                return 1;
            }
        break;
