...
<head>
   ...
   <link rel="stylesheet" href="css/style-catalogoAdmin.css">
...
<div class="container">
   <h3 class="title"><?php echo $_SESSION['Establecimiento'];?></h3>
   <h3 class="subtitle"> Productos Registrados</h3>
 
   <div class="products-container">
   <?php
   $sql= "SELECT * FROM producto WHERE Id_Establecimiento = $varsesion";
...
<script src="js/script-catalogoAdmin.js" defer></script>
